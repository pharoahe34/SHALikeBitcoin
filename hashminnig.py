...
def SHA256(text):
    """
    Takes in a string text, returns the string of sha256
...
def mine(block_number, transactions, previous_hash, prefix_zeros):
    """
    Takes in multiple arguments listed below, returns the desired new hash
...
if __name__ == "__main__":
    ...
    previous_hash = "0000000xa036944e29568d0cff17edbe038f81208fecf9a66be9a2b8321c6ec7" # previous sha256 key started with 7 zero
